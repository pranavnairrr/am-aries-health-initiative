...
const socials = [
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/ariesdental",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
  ...
  {
    name: "TikTok",
    href: "https://tiktok.com/@ariesdental",
    icon: (
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label="Dismiss"
        className="absolute right-3 top-1/2 -translate-y-1/2 text-cream opacity-40 hover:opacity-80 transition-opacity"
      >
        <X size={14} />
      </button>
    </div>
